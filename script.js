function myfunc() {
    ...
    if (b1.toLowerCase() == "х" && b2.toLowerCase() == "x" && b3.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    } else if (b4.toLowerCase() == "х" && b5.toLowerCase() == "x" && b6.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    } else if (b7.toLowerCase() == "х" && b8.toLowerCase() == "x" && b9.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    } else if (b1.toLowerCase() == "х" && b4.toLowerCase() == "x" && b7.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    } else if (b2.toLowerCase() == "х" && b5.toLowerCase() == "x" && b8.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    } else if (b3.toLowerCase() == "х" && b6.toLowerCase() == "x" && b9.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    } else if (b1.toLowerCase() == "х" && b5.toLowerCase() == "x" && b9.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    } else if (b3.toLowerCase() == "х" && b5.toLowerCase() == "x" && b7.toLowerCase() == "x") {
        window.alert('You are a winner');
        reset();
    }
